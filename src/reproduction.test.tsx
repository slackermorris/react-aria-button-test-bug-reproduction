 ...
 *
 * TL;DR:
 * Modal dialogs are not rendered when rendered in a table and the visibility of the modal dialog is managed at the level of the table component and the table rows are generated from render props.
 * Modal dialogs are not rendered when rendered in a table and the visibility of the modal dialog is managed at the level of the table component and the table rows are generated by mapping over an array.
 *
 * Buttons do not show in modal dialogs when the modal dialog is rendered in a table and the visibility of the modal dialog is managed at the level of the table component and the table rows are generated from mapping over an array
...
describe("reproduction of react-aria bug", () => {
  ...
  describe("modal dialog is rendered inside a table", () => {
    ...
    it("does dialog render when table manages show/hide state and rows are generated with map?", async () => {
      render(
        <TableWithModalNotSelfManagingVisibilityIteratingWithMapToGenerateRows />
      );
    ...
    it("do buttons render when table manages show/hide state and rows are generated with map?", async () => {
      render(
        <TableWithModalNotSelfManagingVisibilityIteratingWithMapToGenerateRows />
      );
